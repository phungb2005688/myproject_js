    ...
    <div class="container">
      ...
      <div class=" h-200">
        <div class="row">
          ...
          <div class="col-md-11">
            <hr style="width: 1050px; margin-top: 15px; border: 1px solid #3e3e3e;">
          ...
          <!-- <div class="col-lg-5" style="margin-top: 12px; margin-left: 90px;">
            <span style="font-weight: 600; color: #2e1c11; border-bottom: 2px solid #2e1c11;">Thanh toán trực tuyến</span>
            <div class="card">
                  ...
                  <div class="card-header p-0" id="headingTwo">
                    <h2 class="mb-0">
                      <button style="width: 448px;"
                        class="btn btn-light text-left collapsed p-3 rounded-0 border-bottom-custom" type="button">
                ...
                <div class="card">
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="card-body payment-card-body">
                      <span class="font-weight-normal card-text">Địa chỉ</span>

                      <div class="diachi">
                        <div style="border: 1px solid #ccc; height: 35px; border-radius: 5px; padding-top: 5px;">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="input1">
                            <div style="border: 1px solid #ccc; height: 35px; border-radius: 5px; padding-top: 5px;">
                              ...
                              <span style="padding-left: 50px; font-weight: 500;">Miễn phí</span>
            ...
            <div>
              <div class="pt-3" style="margin-left: 210px;">
                <h5 style="margin-left: 35px;">TỔNG TIỀN: {{ total().toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".") }}
                  đ
                </h5>

                <div class="text-align-center">
                  <div class="d-flex justify-content-between mb-5">
                    <button class="btn thanhtoan">
                      <router-link to="/thank" class="text-white text-decoration-none"> Xác nhận thanh toán <i
          ...
          <div> <h5 style="margin-left: 790px; margin-top: 7px;">TỔNG TIỀN: {{ total().toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".") }}
                  đ
                </h5>
              <div class="d-flex pt-3" style="margin-left: -70px;">
                <div class="text-align-center">
                  <div class="d-flex justify-content-between mb-5">
                ...
                <div class="text-align-center" style="margin-left: 530px;">
                  <div class="d-flex justify-content-between mb-5">
                    <button class="btn thanhtoan">
                      <router-link to="/Order" class="text-white text-decoration-none"> Xác nhận thanh toán <i
                          class="fa-solid fa-arrow-right"></i></router-link>
                    </button>
                  </div>
                </div>
